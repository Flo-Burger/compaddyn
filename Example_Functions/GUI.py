...
class Controller:
    """
    The Controller holds shared data and creates/destroys GUI windows.
    """
    def __init__(self):
        self.root = tk.Tk()
    ...
    def launch_gui(self):
        """Launch the GUI by displaying the first page."""
        self.page_one = PageOneWindow(self)
        self.root.mainloop()  # Now only runs when called

    def show_page_two(self):
        """Move to PageTwoWindow."""
    ...
    def run_analysis(self):
        """Perform the analysis and save results."""
